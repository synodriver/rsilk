...
pub fn encode(input: Vec<u8>, sample_rate: i32, bit_rate: i32, max_internal_sample_rate: i32, packet_loss_percentage: i32, complexity: i32, use_inband_fec: bool, use_dtx: bool, tencent: bool) -> PyResult<PBytes> {
...
pub fn decode(src: Vec<u8>, sample_rate: i32, frame_size: i32, frames_per_packet: i32, more_internal_decoder_frames: bool, in_band_fec_offset: i32, loss: bool) -> PyResult<PBytes> {
